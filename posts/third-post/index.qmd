...
The final step of the main data wrangling was to create the average evaluation ratings for the Danielson and Disposition evaluations, and this is why I had to mutate the data into numeric values. 
